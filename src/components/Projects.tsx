...
const sectionText = {
   vi: {
      title: "Dự án", subtitle: "Dự án nổi bật",
      viewLive: "Xem demo trực tiếp", teamSize: "Thành viên", keyFeatures: "Tính năng chính",
   },
   en: {
      title: "Projects", subtitle: "Featured Project",
      viewLive: "View Live Demo", teamSize: "Team members", keyFeatures: "Key Features",
   },
   ja: {
      title: "プロジェクト", subtitle: "注目のプロジェクト",
      viewLive: "デモを見る", teamSize: "チームメンバー", keyFeatures: "主な機能",
   },
};
   ...
   return (
      <section id="projects" className="section">
         <div className="container-custom">
            ...
            >
               <span className="text-primary-400 text-sm uppercase tracking-wider">{text.title}</span>
                  ...
                  <div className="grid lg:grid-cols-2 gap-0">
                     ...
                     <div className="relative h-64 lg:h-auto lg:min-h-[400px] bg-gradient-to-br from-primary-900/50 to-accent/30 overflow-hidden">
                        {project.image ? (
                           ...
                           <div className="absolute inset-0 flex items-center justify-center">
                              <span className="text-6xl font-bold text-white/10">{project.title}</span>
                           </div>
                        )}
                     ...
                     <div className="p-8 lg:p-10 flex flex-col">
                        <div className="flex items-start justify-between mb-4">
                           <div>
                              <h3 className="text-2xl lg:text-3xl font-bold gradient-text">{project.title}</h3>
                              <p className="text-primary-400 mt-1">{project.subtitle[language]}</p>
                           </div>
                           {project.liveUrl && (
                              <a
                        ...
                        <p className="text-gray-300 leading-relaxed mb-6">{project.description[language]}</p>
                           ...
                           <div className="grid sm:grid-cols-3 gap-3 text-sm">
                              <div className="bg-white/5 p-3 rounded-lg">
                                 ...
                                 <div className="text-gray-400 text-xs space-y-1">
                                    <p>admin@example.com</p><p>Pass: 123</p>
                                 </div>
                              </div>
                              <div className="bg-white/5 p-3 rounded-lg">
                                 ...
                                 <div className="text-gray-400 text-xs space-y-1">
                                    <p>anhs2030@example.com</p><p>Pass: 123</p>
                                 </div>
                              </div>
                              <div className="bg-white/5 p-3 rounded-lg">
                                 <div className="text-primary-400 font-medium mb-1">
                                 ...
                                 <div className="text-gray-400 text-xs space-y-1">
                                    <p>thanhphuong12a1</p><p>@gmail.com</p><p>Pass: 123</p>
                                 </div>
                              </div>
                           </div>
                        </div>
